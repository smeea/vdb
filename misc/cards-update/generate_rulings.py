...
with open("rulings/groups.yaml", "r") as groups_file, open("rulings/references.yaml", "r") as references_file, open("rulings/rulings.yaml", "r") as rulings_file, open("rulings.json", "w", encoding="utf8") as rulings_output:
