...
export const BLOCK_DENIAL = "block denial";
...
export const SURPLUS_FIXED = "urplusFixed";
...
export const CRYPT_SEARCH_SORT = "cryptSearchSort";
export const CRYPT_DECK_SORT = "cryptDeckSort";
export const CRYPT_INVENTORY_SORT = "cryptInventorySort";
export const LIBRARY_SEARCH_SORT = "libraryInventorySort";
export const LIBRARY_INVENTORY_SORT = "libraryInventorySort";
export const DECKS_ADV_SORT = "decksAdvSort";
export const TWD_SEARCH_SORT = "twdSearchSort";
export const PDA_SEARCH_SORT = "pdaSearchSort";
export const TDA_SEARCH_SORT = "tdaSearchSort";
export const ADD_MODE = "addMode";
export const INVENTORY_MODE = "inventoryMode";
export const LIMITED_MODE = "limitedMode";
export const LIMITED_PRESET = "limitedPreset";
export const PLAYTEST_MODE = "playtestMode";
export const SHOW_IMAGE = "showImage";
export const SHOW_LEGACY_IMAGE = "showLegacyImage";
export const RECENT_DECKS = "recentDecks";
export const ONLINE = "online";
export const OFFLINE = "offline";
export const CARD_VERSION_KEY = "cardVersion";
export const CRYPT_CARDBASE = "cryptCardBase";
export const LIBRARY_CARDBASE = "libraryCardBase";
export const LOCALIZED_CRYPT = "localizedCrypt";
export const LOCALIZED_LIBRARY = "localizedLibrary";
export const PRECON_DECKS = "preconDecks";
export const IS_PLAYTEST = "isPlaytest";
export const IS_PLAYTESTER = "is_playtester";
export const IS_ADMIN = "is_admin";
export const SHARED_KEY = "shared_key";
export const THEME = "theme";
export const SEATING_WITH_CUSTOM = "seatingWithCustom";
export const SEATING_WITH_STANDARD = "seatingWithStandard";
export const SEATING_CUSTOM_DECKS = "seatingCustomDecks";
