          ...
          <div className="  ">
            ...
            <div>
              ...
              <div>
                ...
                <ul>
                  ...
                  <li>
                    Accept latin-only and unicode letters as card name (e.g.
                    will match Lise & Lisé, Zurich & Zürich)
                  </li>
                  <li>
                    Accept{' '}
              ...
              <div>
                ...
                <ul>
                  <li>
                    ...
                    particular vampire (both Base + Adv), excluding Anarch
                    Convert (does not counted at all).
                    <ul>
                      <li>
                    ...
                    Reason for strange percentage (38%) is to include decks with
                    5 of 13 vampires (38,4%), but exclude everything below
                    starting from decks with 3 of 8 vampires (with 4+ Anarch
                    Converts (37,5%))
                  </li>
                </ul>
                ...
                <ul>
                  <li>
                    ...
                    given clan, excluding Anarch Convert (does not counted at
                    all)
                    <ul>
                      <li>
                        E.g.: 5x Ventrue + 3 Anarch Convert + 3x Other is
                        Ventrue Deck
                        <tt>
                          <i> -&gt; 5/(5+3) = 62%</i>
                        </tt>
                ...
                <ul>
                  <li>
                    Calculated excluding Anarch Convert (does not counted at
                    all)
                    <ul>
                      <li>
                ...
                <ul>
                  ...
                  <li>
                    Multi-discipline cards considered as of all given
                    disciplines
                    <ul>
                      <li>
                        E.g.: Deck with Condemnation: Mute (chi/dai/DAI card)
                        will match Chimerstry search, even if it was never
                        planned by the deck to use it with chi.
                      </li>
                    </ul>
                  </li>
                </ul>
            ...
            <div>
              ...
              <div>
                ...
                <ul>
                  <li>
                    Public it can be searched (using similar set of filters as
                    for TWDA), viewed, copied by other players in the PDA page,
                    and can be deleted by the author (but as with any other
                    deck, author cannot delete your copy of the deck made with
                    Copy deck button)
                  </li>
                  <li>
                    Public Deck is created from one of your existing deck
                    (parent) in the Decks page using Public Archive button
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    (feel free to use Description to give cross-references
                    between sister decks and/or give any explanation you want)
                  </li>
                  <li>
                    Author can remove the deck from PDA anytime, but each re-add
                    creates new copy of the deck and it will be listed again
                    (not available for those who add it to Favorites before
                    deletion)
                  </li>
                  <li>
                    Deck author name is public author name (same you see in Deck
                    view page), it is not unique (no ownership), can be
                    different from your account name and can be changed anytime
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div>
              ...
              <div>
                <ul>
                  ...
                  <li>
                    Hovering over card name will popup card image or textual
                    card description. To switch between image/text layouts click{' '}
              ...
              <div>
                ...
                <ul>
                  <li>
                    ...
                    anything to save the deck. If it cannot save the change
                    (i.e. network problem) it will immediatelly revert the
                    change, the cards you see in the deck is what actually saved
                    on the server. You can close the page anytime without losing
                    progress.
                  </li>
                  <li>
                ...
                <ul>
                  ...
                  <li>
                    Immutable URL - create link to unchangeable copy of the
                    deck. Good for forum/blog posts and where you want everybody
                    to have same exact deck forever (your future changes in the
                    deck will not change the deck by the link).
                  </li>
                  <li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    existing hand (with respect to hand size and discarded
                    cards). It is not the chance to draw additional cards to
                    your hand, but chance to draw cards in the hand in the first
                    place (imagine you return hand to the library, excluding
                    already played cards, shuffle it and draw back to your hand
                    size)
                  </li>
                  <li>
                    Draw calculation code (requires a little programming
                    literacy to read) is{' '}
            ...
            <div>
              ...
              <div>
                ...
                <ul>
                  <li>
                    Go to Crypt or Library search page (the one you use to
                    search all VTES cards)
                  </li>
                  <li>Activate Inventory Mode in the top-left corner</li>
                  <li>
                    Now all searches you do will search in your inventory (and
                    you can swap to-from all VTES cards any time to repeat
                    search with new &#39;source&#39;)
                  </li>
                  <li>
                ...
                <SubTitle>
                  To track how cards are used in your decks, each deck has the
                ...
                <ul>
                  <li>
                    ...
                    management tracking, like you want for virtual Lackey decks
                  ...
                  <li>
                    ...
                    want for your temporary test decks or if your card pool is
                    not big (yet)
                  </li>
                  <li>
                    <div className="inline ">
                ...
                <p>
                  ...
                  fixed except few Masters you swap between decks) clicking on
                  the icon to the left of the card in the deck list. All other
                  cards of the deck will continue to be of the deck status
                </p>
              </div>
            </div>
          </div>
