...
function LibraryResultHeader(props) {
  return (
    <thead>
...
function LibraryResultCost(props) {
  const costicons = {
    1: [blood1, pool1],
    2: [blood2, pool2],
    3: [blood3, pool3],
...
function LibraryResultName(props) {
  return (
    <td width='44%'>
      {props.value}
    </td>
...
function LibraryResultDiscipline(props) {
...
function LibraryResultType(props) {
  const typeicons = {
    Action: action,
  ...
  const imgSrc=typeicons[props.value];
...
function LibraryResultBurn(props) {
...
function LibraryResultClan(props) {
  const clanicons = {
...
function LibraryResultBody(props) {
  ...
  const cards = props.resultCards.map((card, index) => {
    ...
    return (
      <tr className={resultTrClass} key={index}>
        <LibraryResultCost valueBlood={card['Blood Cost']} valuePool={card['Pool Cost']} />
        <LibraryResultType value={card['Type']} />
        <LibraryResultDiscipline value={card['Discipline']} />
        <LibraryResultName value={card['Name']} />
        <LibraryResultBurn value={card['Burn Option']} />
        <LibraryResultClan value={card['Clan']} />
      </tr>
    );
  });
...
function LibraryDeckQuantity(props) {
...
function LibraryDeckBody(props) {
  let resultTrClass='library-result-even';
  const cards = props.cards.map((card, index) => {
    ...
    return (
      <tr className={resultTrClass} key={index}>
        ...
        <LibraryResultClan value={card[0]['Clan']} />
      </tr>
    );
  });
